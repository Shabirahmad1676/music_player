...
import { CgPlayListAdd, CgPlayTrackNext, CgPlayTrackPrev } from "react-icons/cg";
  ...
  return (
    <div className="bg-black h-screen w-full flex">
      ...
      <div className="w-[100%] md:w-[50%] h-full hidden md:flex flex-col gap-3 overflow-auto pt-[120px] pb-4">
       {songsData.map((songs)=>(
        <Card name={songs.name}  singer={songs.singer} image={songs.image} songsIndex={songs.id-1} />
       ))}
      </div>
    </div>
  );
